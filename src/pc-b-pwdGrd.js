...
define(function(require, exports, module) {
    ...
    var passwordModule = require("./pc-b-password");
    ...
    PwdGrdModule.prototype = {
        ...
        _addDownloadBubble: function(ctrlPath) {
            ...
            if(this._getBrowserName() === "Chrome") {
                ...
                html.push('<div class="pwdGrd-Dlg-foot"><div style="padding-top: 10px;">' + this._getBrowserName() + " 用户，请允许使用控件</span><a style='float: right;color:#0087e3;' href=\"/helpcenter/question?anchor=pwdgrd\">帮助？</a></div>");
            }
            html.push("</div>");
